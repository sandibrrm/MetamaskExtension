// src/lib.rs
/*
 * Core library for MetamaskExtension
 */
...
#[derive(Debug)]
pub struct MetamaskExtensionProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetamaskExtensionProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetamaskExtension processing");
    
    let mut processor = MetamaskExtensionProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetamaskExtensionProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetamaskExtensionProcessor::new(false);
